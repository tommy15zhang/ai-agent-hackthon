...
def AI_Response(path):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": "IMPORTANT: Output only the commands. Make sure that no files are left out. Once done, the original path should only have the main folders in it."},
